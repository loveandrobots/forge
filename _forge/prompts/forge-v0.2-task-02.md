...
You are implementing task 2: Database schema and query layer
...
When finished, run the tests (python -m pytest tests/) and all test criteria, and confirm they pass before committing.
